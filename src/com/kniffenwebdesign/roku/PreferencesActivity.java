...
public class PreferencesActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ipAddressPreference = (EditTextPreference) getPreferenceScreen().getPreference(0);
	...
	class OnIpAddressPreferenceChangeListener implements OnPreferenceChangeListener {
